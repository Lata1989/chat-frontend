...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    ...
    >
      ...
      <div className="text-2xl font-semibold mb-6">Harry Woodworm</div>
      <div className="mb-4">
        <button
          onClick={createChat}
          className="w-full py-2 bg-gray-700 hover:bg-gray-600 rounded"
        >
          {createLod ? <LoadingSpinner /> : "Nuevo chat +"}
        </button>
      </div>
      <div>
        <p className="text-sm text-gray-400 mb-2">Recientes</p>
